...
public class Classification {
	public static void main(String[] args)throws Exception {
         ...
         * random generator
         */
        Map<Object, PerformanceMeasure> p = cv.crossValidation(data, 4, new Random(1));

        Map<Object, PerformanceMeasure> q = cv.crossValidation(data, 4, new Random(1));

        Map<Object, PerformanceMeasure> r = cv.crossValidation(data, 4, new Random(25));
